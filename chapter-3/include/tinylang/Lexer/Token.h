...
public:
  ...
  /* Fold Expression: (... || is(Toks)) is a C++17 feature.
     This particular fold expression expands to a series of
     logical OR (||) operations applied to the result of is(Toks)
     for each token kind in Toks. 
  */
